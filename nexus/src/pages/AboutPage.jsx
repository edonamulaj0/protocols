  ...
  return (
    <div className="mx-auto max-w-xl">
      ...
      <p className="mt-4 text-[var(--muted)]">
        ...
        editorial layout. You sign in with Google; we keep your name, email, and the age you enter only in your browser for comments and your
        profile summary—no Nexus server account.
      </p>
      <p className="mt-4 text-[var(--muted)]">
